...
Organization administrators may always bypass this ruleset. All other contributors are expected to follow the protections above.

## Source of truth

The machine-readable configuration is [`rulesets/main-branch-ruleset.json`](rulesets/main-branch-ruleset.json). Update that file when the policy changes, and keep this README aligned with it.
